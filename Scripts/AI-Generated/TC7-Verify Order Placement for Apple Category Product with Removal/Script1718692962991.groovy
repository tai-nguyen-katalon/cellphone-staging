...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 2: Hover over item phone2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 3: Click on link appleCategory2.png')

"Step 4: Select iPhone 15 specifications and place order"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 7: Click on link goShopping - Navigate to page .png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 8: Hover over item phone2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 9: Click on link appleCategory2.png')

"Step 10: Select iPhone 15 specifications and place order"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 11: Click on button proceedCheckout.png')

"Step 12: Provide shipping details and proceed to payment"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 13: Click on radio cashOnDelivery.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Verify Order Placement for Apple Category Product with Removal_visual_checkpoint')
