...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 2: Click on button marsLogoRowHamburger.png')

"Step 3: Explore Apple accessories and filter by price range"

exploreAppleAccessoriesAndFilterByPrice.execute(data_path_0, Integer.valueOf(index_0))

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Explore Apple Accessories with Mars Logo_visual_checkpoint')
