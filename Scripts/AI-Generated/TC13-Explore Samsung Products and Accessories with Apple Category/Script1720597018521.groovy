...
import katalon.common.viewPhoneCategoryAndFilterByPrice
...
"Step 2: Hover over phone item, select category, set price range, and show results"

viewPhoneCategoryAndFilterByPrice.execute(data_path_0, Integer.valueOf(index_0))

"Step 3: Click on link samsung"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/link_samsung', ['dynamicClassVariable': GlobalVariable.link_samsung_dynamicClassVariable, 'dynamicInternalRoleLinkNameVariable': GlobalVariable.link_samsung_dynamicInternalRoleLinkNameVariable]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Explore Samsung Products and Accessories with Apple Category_visual_checkpoint')
