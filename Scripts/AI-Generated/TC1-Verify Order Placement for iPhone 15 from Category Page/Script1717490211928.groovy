...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4: Click on link Phone - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 5: Enter input value in input field price min.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 6: Enter input value in input field price max.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 7: Click on button Show 4.png')

"Step 7: Navigate to iPhone 15 product page, select options, and place an order"
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 9: Click on button Increased.png')

"Step 9: Proceed through checkout steps, provide shipping info, select payment method, and complete order"
