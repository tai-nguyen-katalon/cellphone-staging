...
'step 9: At Page category accessories click on button add to cart'

testObj = findTestObject('AI-Generated/Page_category_accessories/button_add_to_cart_1')
...
'step 10: At Page category accessories click on button add to cart'
...
'step 11: Add visual checkpoint at Page category accessories'

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Verify Navigation to Category Page and Add Items to Cart_visual_checkpoint')
