...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_product/button_object_1'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_product/button_object_1'))
...
"Step 10: Click on link 'Place an order'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Verify Successful Checkout Process with Samsung Galaxy Z Fold4 Silicon Cover_visual_checkpoint')
