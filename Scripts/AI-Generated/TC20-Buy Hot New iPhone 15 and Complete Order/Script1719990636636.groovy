...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 2: Click on link categorySamsung - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 3: Click on button hotNewiPhone15From.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 4: Click on label dialogLabel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 5: Click on button buyDialog2 - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 6: Click on button increased.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 7: Click on button proceedCheckout.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 9: Click on radio cashOnDelivery.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 10: Click on button completeOrder - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Buy Hot New iPhone 15 and Complete Order_visual_checkpoint')
