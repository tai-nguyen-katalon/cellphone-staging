...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 2: Click on div swiperSliderContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 3: Click on button newiPhone15PlusFrom120000.png')

"Step 4: Click on label 256Gb"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/label_256Gb_1'))

WebUI.takeScreenshot(reportLocation + '/TC14/Step 4: Click on label 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 5: Click on label pink.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 6: Click on button close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 7: Hover over item phone2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 8: Click on link appleCategory2 - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 9: Hover over item accessoriesAppleSamsung.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 10: Click on link apple.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 11: Click on button newiPhone15SiliconeCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 12: Click on button close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 13: Click on button newiPhone15SiliconeCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 14: Click on button close - Navigate to page .png')

"Step 15: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Purchase iPhone 15 Silicone Case_visual_checkpoint')
