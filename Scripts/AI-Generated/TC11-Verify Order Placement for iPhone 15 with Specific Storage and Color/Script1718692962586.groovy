...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 3: Click on link iPhone15 - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 4: Click on label 128Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 5: Click on label blue.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 6: Click on link placeOrderCart2 - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 9: Click on radio cashOnDelivery.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 10: Click on button completeOrder - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Verify Order Placement for iPhone 15 with Specific Storage and Color_visual_checkpoint')
