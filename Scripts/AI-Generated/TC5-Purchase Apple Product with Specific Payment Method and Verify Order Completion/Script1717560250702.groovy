...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 2: Hover over list item.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 6: Click on button Show 4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 7: Click on button.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 8: Click on label.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 9: Click on button Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 10: Hover over list item.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 11: Click on link Phone - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 12: Click on input field payment method id.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 13: Click on button COMPLETE ORDER - Navigate to page thank-you.png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Purchase Apple Product with Specific Payment Method and Verify Order Completion_visual_checkpoint')
