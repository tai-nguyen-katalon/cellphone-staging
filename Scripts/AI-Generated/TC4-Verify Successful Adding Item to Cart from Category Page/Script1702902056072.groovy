...
'step 3: At Page category click on button add to cart'
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Successful Adding Item to Cart from Category Page_visual_checkpoint')
