...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 2: Hover over div.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 3: Click on div.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 4: Hover over link.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 5: Click on link.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 16: Hover over div.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 17: Click on button Add to cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 18: Click on link Place an order - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 19: Click on button Increased.png')

"Step 20: Proceed through checkout process with shipping and payment details"

completeCheckoutWithShippingAndPayment.execute(data_path_0, Integer.valueOf(index_0))

"Step 21: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Add Multiple Items to Cart and Verify Checkout Completion_visual_checkpoint')
