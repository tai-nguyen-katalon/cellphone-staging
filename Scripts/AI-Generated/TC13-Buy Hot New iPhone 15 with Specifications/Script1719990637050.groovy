...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 2: Hover over item phone2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 3: Click on link appleCategory2 - Navigate to page category.png')

"Step 4: Click on button hotNewiPhone15From"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/button_hotNewiPhone15From'))

WebUI.takeScreenshot(reportLocation + '/TC13/Step 4: Click on button hotNewiPhone15From.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 5: Click on label 256Gb.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 6: Click on button buyDialog2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 7: Click on label yellow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 8: Click on button dialogButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 9: Click on link cart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 10: Click on list horizontalMenu.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 11: Click on link appleCategory - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Buy Hot New iPhone 15 with Specifications_visual_checkpoint')
