...
'step 5: At Page home click on button add to cart'
...
'step 6: At Page home click on button add to cart'
...
'step 8: Add visual checkpoint at Page home'

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Navigation to Cart and Go to Home_visual_checkpoint')
