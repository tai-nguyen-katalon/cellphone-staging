...
import katalon.common.exploreAccessoriesSortSelectCase
...
"Step 2: Explore accessories category, sort by price, and select a new iPhone 15 silicone case"

exploreAccessoriesSortSelectCase.execute()
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3: Click on button buyDialog2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4: Click on link placeOrderCart2 - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 6: Click on button proceedCheckout.png')

"Step 7: Subscribe with email, provide shipping details, and proceed to payment"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Checkout Process for iPhone 15 Silicone Case Purchase_visual_checkpoint')
