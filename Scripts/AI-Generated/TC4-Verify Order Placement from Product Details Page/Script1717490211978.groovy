...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3: Click on button.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4: Click on label.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5: Click on label.png')

"Step 5: Click on button 'Buy'"

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/button_buyDialog'))
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 7: Click on link Place an order - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 8: Click on button Increased.png')

"Step 8: Proceed through checkout steps, provide shipping info, select payment method, and complete order"
