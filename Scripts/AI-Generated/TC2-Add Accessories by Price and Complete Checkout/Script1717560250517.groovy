...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 2: Hover over list item.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 3: Click on link Accessories - Navigate to page category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 4: Click on link By price.png')

"Step 5: Sort by price, add to cart, and increase quantity"

sortAddToCartAndIncreaseQuantity.execute()

"Step 6: Proceed through checkout process with shipping and payment details"

completeCheckoutWithShippingAndPayment.execute(data_path_0, Integer.valueOf(index_0))

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Add Accessories by Price and Complete Checkout_visual_checkpoint')
