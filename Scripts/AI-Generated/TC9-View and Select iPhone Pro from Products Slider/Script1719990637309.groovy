...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 3: Click on link iphoneProHotNewBestChoice - Navigate to page .png')

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-View and Select iPhone Pro from Products Slider_visual_checkpoint')
