...
"Step 3: Browse Apple accessories, set price range, and view results"

browseAppleAccessoriesSetPriceRange.execute(data_path_0, Integer.valueOf(index_0))

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Explore Apple Accessories via Hamburger Menu_visual_checkpoint')
